...
const Accordination = ({ title, children, Id, Index, setIndex }) => {
  const handleSetIndex = (Id) => Index !== Id && setIndex(Id);
  return (
    <>
    <div
      onClick={() => handleSetIndex(Id)}
      className="flex group cursor-pointer w-full h-18 pt-2 pb-2 justify-between items-center uppercase tracking-wide text-gray-700 text-xs font-bold  hover:bg-gray-100 border-b-1 border-slate-100"
    >
